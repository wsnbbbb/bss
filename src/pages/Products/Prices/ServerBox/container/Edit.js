...
import { SYS_DICT_COMMON } from '@src/config/sysDict'; // 全局变量
...
export default class Edit extends React.PureComponent {
  ...
  onFinish = (value) => {
    ...
    this.props.record.price = value.price;
    this.props.record.currency =  value.currency;
    http
      .post(`${BSS_ADMIN_URL}/api/goods/crate-price/add-update`, tools.clearNull(this.props.record))
      .then((res) => {
        res = res.data;
        if (res.code === 20000) {
          this.onClose();
