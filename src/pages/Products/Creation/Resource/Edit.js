...
import { Steps, Button, message, Breadcrumb, Cascader, Modal } from 'antd';
import '../index.less';
...
class Edit extends React.Component {
 ...
 postData = () => {
   ...
   // 设置交易配置
   param['tradingConfig'] = transactionInfo;
   // 服务对象
 ...
 render () {
   const { current, categoryOk, categoryId, productInfo, defaultMinRes} = this.state;
   console.log(defaultMinRes);
   return (
     <div>
       <div className="bread">
         <Breadcrumb>
       ...
       <div style={{marginTop: 20}}>
         ...
         {current == 0 && <div className="steps-content">
           <Cascader
             ...
             fieldNames={{label: "name", value: "id", children: "children"}}
           />
           {/* <Button type="primary" onClick={() => {this.categoryOk('sure');}}>确定</Button> */}
           {/* <div style={{marginTop: 20}}>
              <Button type="primary" onClick={() => {this.categoryOk('sure');}}>确定</Button>
            </div> */}
         </div>}
