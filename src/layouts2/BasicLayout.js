...
import {watermark, clearWatermark} from "@src/util/water";// 水印
...
export default class AppContainer extends React.Component {
  ...
  constructor (props) {
    ...
    this.state = {
      ...
      clearLoading: false // 用户消息是否正在清除
    };
  }
  componentDidMount () {
    console.log('生成水印');
    clearWatermark(); // 防止水印重复
    watermark({watermark_txt: `${User.getInfo().name} ${User.getInfo().loginTime}`});
  }
      ...
      <div className="page-basic">
        <div className="fixed-top">
          <div style={{height: 52}}>
            ...
            />
            <Collect></Collect>
            <div style={{position: "absolute", top: 10, right: 0, width: 700, textAlign: 'right'}}>
              <Search></Search>
              <Users></Users>
            </div>
          </div>
